...
recording_metadata_file=fullfile(input_directory,patient_id,[strcat(patient_id,".tsv")]);
...
header_file=strsplit([strcat(recording_location,".hea")],'/');
header_file=header_file{end};

header=strsplit(fileread([strcat(recording_location,".hea")]),'\n');
...
load([strcat(recording_location,".mat")],'val')
