...
f=open('dict_bands5.txt','w')
f.write(json.dumps(dict_per_cpc))
f.close()'''

'''with open('dict.txt', 'r') as file:
    dict_per_cpc = json.load(file)
...
for i in range(1,6):
    for j in range(1,19):
        if(i==1 or i==2):
            good+=dict_per_cpc[str(i)][str(j)][0]
            good_len+=dict_per_cpc[str(i)][str(j)][1]
        else:
            bad+=dict_per_cpc[str(i)][str(j)][0]
            bad_len+=dict_per_cpc[str(i)][str(j)][1]
print('\nAverage for Good recovery: ',good/good_len)
print('\nAverage for Bad recovery: ',bad/bad_len)

#can also try ratio of bands'''
with open('dict_bands_win1.txt', 'r') as file:
    dict_per_cpc = json.load(file)
...
for k in b:
    ...
    for i in range(1,6):
        for j in range(1,19):
            if(i==1 or i==2):
                good1+=dict_per_cpc[k][str(i)][str(j)][0]
                good_len1+=dict_per_cpc[k][str(i)][str(j)][1]
                good2+=dict_per_cpc[k][str(i)][str(j)][2]
                good_len2+=dict_per_cpc[k][str(i)][str(j)][3]
                good3+=dict_per_cpc[k][str(i)][str(j)][4]
                good_len3+=dict_per_cpc[k][str(i)][str(j)][5]
            else:
                #print(dict_per_cpc[k][str(i)][str(j)][3])
                bad1+=dict_per_cpc[k][str(i)][str(j)][0]
                bad_len1+=dict_per_cpc[k][str(i)][str(j)][1]
                bad2+=dict_per_cpc[k][str(i)][str(j)][2]
                bad_len2+=dict_per_cpc[k][str(i)][str(j)][3]
                bad3+=dict_per_cpc[k][str(i)][str(j)][4]
                bad_len3+=dict_per_cpc[k][str(i)][str(j)][5]

    print(good_len2,bad_len2)
    print('\nAverage for Good recovery relative and band ',k,' : ',good2/good_len2)
    print('\nAverage for Bad recovery relative and band ',k,' : ',bad2/bad_len2)
    print('\nAverage for Good recovery total and band ',k,' : ',good3/good_len3)
    print('\nAverage for Bad recovery total and band ',k,' : ',bad3/bad_len3)

print('\nAverage for Good recovery: ',good1/good_len1)
print('\nAverage for Bad recovery: ',bad1/bad_len1)
...
for k in b:
    ...
    for i in range(1,6):
        for j in range(1,19):
            if(i==1):
                cpc1+=dict_per_cpc[k][str(i)][str(j)][2]
                cpc1_len+=dict_per_cpc[k][str(i)][str(j)][3]
                cpc1_1+=dict_per_cpc[k][str(i)][str(j)][4]
                cpc1_len_1+=dict_per_cpc[k][str(i)][str(j)][5]
            elif(i==2):
                cpc2+=dict_per_cpc[k][str(i)][str(j)][2]
                cpc2_len+=dict_per_cpc[k][str(i)][str(j)][3]
                cpc2_2+=dict_per_cpc[k][str(i)][str(j)][4]
                cpc2_len_2+=dict_per_cpc[k][str(i)][str(j)][5]
            elif(i==3):
                cpc3+=dict_per_cpc[k][str(i)][str(j)][2]
                cpc3_len+=dict_per_cpc[k][str(i)][str(j)][3]
                cpc3_3+=dict_per_cpc[k][str(i)][str(j)][4]
                cpc3_len_3+=dict_per_cpc[k][str(i)][str(j)][5]
            elif(i==4):
                cpc4+=dict_per_cpc[k][str(i)][str(j)][2]
                cpc4_len+=dict_per_cpc[k][str(i)][str(j)][3]
                cpc4_4+=dict_per_cpc[k][str(i)][str(j)][4]
                cpc4_len_4+=dict_per_cpc[k][str(i)][str(j)][5]
            elif(i==5):
                cpc5+=dict_per_cpc[k][str(i)][str(j)][2]
                cpc5_len+=dict_per_cpc[k][str(i)][str(j)][3]
                cpc5_5+=dict_per_cpc[k][str(i)][str(j)][4]
                cpc5_len_5+=dict_per_cpc[k][str(i)][str(j)][5]

    print(good_len2,bad_len2)
    print('\nAverage for CPC 1 (relative) and band ',k,' : ',cpc1/cpc1_len)
    print('\nAverage for CPC 2 (relative) and band ',k,' : ',cpc2/cpc2_len)
    print('\nAverage for CPC 3 (relative) and band ',k,' : ',cpc3/cpc3_len)
    print('\nAverage for CPC 4 (relative) and band ',k,' : ',cpc4/cpc4_len)
    print('\nAverage for CPC 5 (relative) and band ',k,' : ',cpc5/cpc5_len)
    print('\nAverage for CPC 1 (total) and band ',k,' : ',cpc1_1/cpc1_len_1)
    print('\nAverage for CPC 2 (total) and band ',k,' : ',cpc2_2/cpc2_len_2)
    print('\nAverage for CPC 3 (total) and band ',k,' : ',cpc3_3/cpc3_len_3)
    print('\nAverage for CPC 4 (total) and band ',k,' : ',cpc4_4/cpc4_len_4)
    print('\nAverage for CPC 5 (total) and band ',k,' : ',cpc5_5/cpc5_len_5)